...
public class CS359DB {
    ...
    private static final String UNAME = "csd3978"; // Share your repo to give you the credentials
    private static final String PASSWD = "D$Y^3@VH";  // Share your repo to give you the credentials
